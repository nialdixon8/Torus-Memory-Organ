...
export function readHTTPMsg(expectRequest, r) {
    ...
    return [
        ...
        (async () => {
            ...
            const bodyStreamControllerPromise = defer();
            ...
            // Handle the body
            milo.setOnData(parser, (_, from, size) => {
                const c = unconsumedChunks.subarray(from, from + size);
